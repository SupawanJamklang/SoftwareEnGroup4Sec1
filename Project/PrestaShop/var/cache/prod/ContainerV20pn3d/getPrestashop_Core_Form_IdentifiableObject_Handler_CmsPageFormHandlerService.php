...
return $this->services['prestashop.core.form.identifiable_object.handler.cms_page_form_handler'] = ($this->services['prestashop.core.form.identifiable_object.handler.form_handler_factory'] ?? $this->load('getPrestashop_Core_Form_IdentifiableObject_Handler_FormHandlerFactoryService.php'))->create(($this->services['prestashop.core.form.identifiable_object.data_handler.cms_page_form_data_handler'] ?? $this->load('getPrestashop_Core_Form_IdentifiableObject_DataHandler_CmsPageFormDataHandlerService.php')));
