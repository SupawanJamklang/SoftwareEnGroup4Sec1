...
class FeatureFlag extends \PrestaShopBundle\Entity\FeatureFlag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'id', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'name', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'state', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'labelWording', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'labelDomain', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'descriptionWording', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'descriptionDomain', '' . "\0" . 'PrestaShopBundle\\Entity\\FeatureFlag' . "\0" . 'stability'];
        }
     ...
     * {@inheritDoc}
     */
    public function setStability(string $stability): \PrestaShopBundle\Entity\FeatureFlag
    {
