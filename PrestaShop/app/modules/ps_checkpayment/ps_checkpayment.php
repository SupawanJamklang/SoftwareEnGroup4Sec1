...
class Ps_Checkpayment extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Payments by Counter server.', [], 'Modules.Checkpayment.Admin');
    ...
    public function hookPaymentOptions($params)
    {
        ...
        $newOption->setModuleName($this->name)
            ->setCallToActionText($this->trans('Pay by Counter service', [], 'Modules.Checkpayment.Admin'))
